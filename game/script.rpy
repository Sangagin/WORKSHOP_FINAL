...
label start:
    ...
    label suite2:
        ...
        # --------------------------------------------------------------------------
        #  JOURNEE 2 (PAS DE PHASE DE GAMEPLAY)
        ...
        "Je vais appeler \"Quatuor\".":
            ...
            menu:
                ...
                "Je préfère que l'on se concentre sur le festival.":
                    "Moi" "On peut aller faire du repérage si ça te chante ?"

                    "Elle tire un air un peu déçu. Mais je préfère tout de même me concentrer sur mon travail."

                    hippie "Ma foi pourquoi pas !"
    ...
    label choix1_non:
        ...
        # On les interrompt quand même, mais on a obtenu un dailogue supplémentaire !
        jump choix1_oui
    ...
    # --------------------------------------------------------------------------
    # Choix 3 : Choix session studio, qui précède un premier rendez-vous
    label choix3_got:
    ...
    label choix3_punk:
        ...
        "Je décide ensuite de me poser et de réécouter les dernières chansons qui ont été enregistrées."
        "Pendant que je travaillais sur les nouvelles chansons, le groupe arrive, me saluant."

        show hugoneutre
        show punkb01 at right
        show punkb02 at left

        "Nous passons la journée à enregistrer les dernières chansons qui devraient être présentées lors du festival."
        "La journée touche encore une fois à sa fin."
        ...
        "J'ai l'impression d'avoir débarqué en ville seulement hier..."
        ...
        if amitie_punk >= 2:
            ...
            # Si on décide de boire de l'alcool les trois fois, on ne peut pas échapper à la bagarre
            if nbBieres == 3:
                jump bagarre
    ...
    label date1_got:
        ...
        # Mini-jeu 2 : Course poursuite contre les policiers
        # SI REUSSITE
        $amitie_got += 1
    ...
    label date1_hippie:
        ...
        menu:
                    ...
                    if (amitie_hippie >= 4):
                        ...
                        menu:
                            "J'aimerai bien me rapprocher d'elle.":
                                ...
                                "Moi" "Ça ne me dérangeait pas tu sais. Un câlin par une aussi jolie fille, ça ne se refuse pas..."
            ...
            "Les balles de jonglage me tentent un peu plus !":
                ...
                "Elle m'explique avec toute la patience du monde comment réussir à en lancer une en l'air puis changer l'autre de main simultanément."
                "Je crois qu'après une vingtaine de minutes j'ai réussi à prendre le coup de main."

                hippie "Waaaah ! Je pensais pas que tu allais y arriver aussi vite ! Tu m'épates !"

                "Fier de moi, je rajoute une balle à jongler et essaie de lui montrer à quel point je suis doué."
                "Evidemment, je fais tomber toutes mes balles après quelques lancers seulement."

                hippie "Hahahahaha ! Tu devrais t'en tenir qu'à deux balles pour le moment !"
                hippie "Il se fait tard, je pense que je vais rentrer."
                hippie "Tu peux garder les balles pour t'entrainer si tu veux, tu me montreras la jongle à trois balles une autre fois !"

                "Jeanne remballe toutes ses affaires de cirque, puis part avec ses amis en rigolant."
                "Après quelques pas, elle se retourne pour me faire signe de la main. Je lève la main également en réponse."
    ...
    label date1_punk:
        ...
        "... mais fut réveillé peu de temps après par ce satané réveil."
    ...
    # Mini-jeu 4 : Préparation de repas pour la gothique
    label prepaBouffe:
    ...
    label finNeg :
        ...
        "Elle me regarde avec un regard haineux, s'avance vers moi et m'attrape par le col."
    ...
    # --------------------------------------------------------------------------
    # DIFFERENTES FINS DU JEU : MAUVAISES NEUTRES ET HEUREUSES
    ...
    label neutralEnding_2:
        ...
        "Moi" "C'est moi qui devrait te remercier. Tu m'as aidé à voir la vie sous un autre angle."
        "Moi" "Tu m'as intégré dans cette ville qui m'était nouvelle alors que tu ne savais encore rien de moi."
        "Moi" "Tu ne juges personne et accepte tout le monde comme il est, je pense que c'est ta plus grande force."
        "Moi" "J'ai vraiment hâte de te voir redonner le sourire aux spectateurs ce soir."
        "Moi" "Je penses vraiment que tu es ma meilleure rencontre ici, et j'espère sincérement que tout le monde ce soir te verra de la même manière que moi."
